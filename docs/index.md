...
- **Primary Code Format**: Standalone Python files in Jupyter Percent format (`# %%` and `# %% [markdown]`)
- **Site Generator**: MkDocs with `mkdocs-jupyter` plugin (`uv run mkdocs build` / `uv run mkdocs serve`)
